...
export default function SimulationPage() {
    ...
    return (
        <div className="min-h-screen pt-24 pb-8 px-4 md:px-8">
            ...
            <div className="fixed top-24 right-4 z-40 space-y-2 w-96">
                <AnimatePresence>
                    {alerts.map(alert => (
                        <motion.div
                            key={alert.id}
            ...
            >
                <h1 className="text-4xl font-bold mb-6 text-center bg-gradient-to-r from-pink-500 via-purple-500 to-cyan-400 bg-clip-text text-transparent">
                    ...
                    >
                        ...
                        <div className="flex items-center justify-between mb-4">
                            ...
                            <button
                                ...
                                className={`relative w-14 h-7 rounded-full transition-colors ${showComparison ? 'bg-cyan-500' : 'bg-gray-600'
                                    }`}
                            >
                                <motion.div
                    ...
                    <div className="flex gap-2 mb-4 border-b border-slate-700 flex-wrap">
                        {[
                            ...
                            <button
                                ...
                                className={`px-4 py-2 rounded-t-lg transition-colors ${activeTab === tab.key
                ...
                >
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        ...
                        <div className="text-center p-4 bg-slate-900/50 rounded-lg">
                            <div className="text-2xl font-bold text-green-400">{summary.efficiency} GHz/W</div>
                            <div className="text-sm text-gray-400 mt-1">Overall Efficiency</div>
                        </div>
                    </div>
                </motion.div>
            </motion.div>
